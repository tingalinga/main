...
*** Wrote additional tests for existing features to increase coverage by 2.9% and 4.7% (Pull requests https://github.com/AY1920S2-CS2103T-W12-2/main/pull/279[#279], https://github.com/AY1920S2-CS2103T-W12-2/main/pull/283[#283])
