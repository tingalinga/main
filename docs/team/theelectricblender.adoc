...
I implemented the student particulars feature, update student image feature, and part of the personal scheduler feature, which inclide:
...
** Updated User Guide with a product survey. (https://github.com/AY1920S2-CS2103T-W12-2/main/pull/62[#62])
...
* Tools
** Integrated a Github plugin (Travis) to the team project
