...
.. Other incorrect delete commands to try: `delete`, `delete john Tan Jun Wei` (where the specified student is not a student in the class list due to the capitalisation of the of the first alphabet.) _{give more}_ +
