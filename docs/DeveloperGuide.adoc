...
The class particulars feature uses the `AddCommandParser` class to parse the user command input into the different command types
and validates the input.
The feature comprises of five commands namely,

* `AddCommand` -Adding students
