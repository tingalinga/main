...
* is the form teacher of a class
...
|`* * *` |form teacher |see the scores of my class |know the academic progress of my class

|`* * *` |form teacher |add a new student |

|`* * *` |form teacher |delete a student |remove entries that I no longer need
...
|`* *` |form teacher |see usage instructions |refer to instructions when I forget how to use the App
...
1.  User keys in a student
2.  TeaPet adds the student to the class list
+
Use case ends.
...
[none]
* 2a. Student is invalid.
+
[none]
** 2a1. TeaPet shows an error message.
+
Use case ends.
...
1.  User specifies which student and what particulars he/she wants to edit
2.  TeaPet edits the student's particulars in the class list
+
Use case ends.
...
2.  TeaPet shows a list of students
3.  User requests to delete a specific student in the list
4.  TeaPet deletes the student
+
Use case ends.
...
+
[none]
** 3a1. TeaPet shows an error message.
+
...
.  TeaPet should be used only for a teacher handling his/her own form class.
