...
* `DefaultStudentDisplayCommand` - Updates the student list to show updated images of students and displays the student list.
...
.Activity Diagram for DefaultStudentDisplayCommand
...
//@@author TheElectricBlender
//tag::uc-simon2[]
=== Use case: UC11 - Add event into schedule
...
=== Use case: UC12 - Delete event from schedule
...
=== Use case: UC13 - Update student profile picture
