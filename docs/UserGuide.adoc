...
|===
|*Command*|*Format*|*Expected outcome*
|`notes add`|`notes add name/NAME c/CONTENT pr/PRIORITY| Adds a note into TeaPet.
|`notes edit`|`notes edit INDEX name/NAME c/CONTENT pr/PRIORITY`|Edits a note in TeaPet.
