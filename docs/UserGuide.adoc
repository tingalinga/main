...
*Sharkie* then allow you to remind your friends through email to return you the money they owe you!
// end::debts[]
...
* The keyword need not be in full. For example `wallet find ri` will display expenses or income with the keyword `rice` as well.
****

Examples:

* `wallet find rice`
Returns a list of expenses and income containing the keyword. +
Expected Outcome:
