...
Assessment description can only be homework or exam. +
Date should be written in YYYY-MM-DD format. +
e.g. `academics add desc/Math Graphs Homework type/homework date/2020-05-02`
...
e.g. `academics edit 4 desc/Chemistry Compounds Assignment type/homework date/2020-04-30`
* *Delete Assessment*: `academics delete INDEX`
* *Submit Assessment*: `academics submit INDEX [stu/STUDENT_NAME]...` +
There should be at least 1 student's work being submitted and students' work should not have been submitted before.
e.g. `academics submit 3 stu/Freddy Zhang` +
e.g. `academics submit 3 stu/Freddy Zhang stu/Gerren Seow` +
* *Mark Assessment*: `academics mark INDEX [stu/STUDENT_NAME-SCORE]...` +
There should be at least 1 student's work being marked and students' work have already been submitted.
e.g. `academics mark 3 stu/Freddy Zhang-90` +
e.g. `academics mark 3 stu/Freddy Zhang-90 stu/Gerren Seow-80` +
* *Filter Assessment by type*: `academics ASSESSMENT_TYPE` +
e.g. `academics exam`
