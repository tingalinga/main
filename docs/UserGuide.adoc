...
*Expected Outcome:*
    ...
    ADD NOTE: notes add name/STUDENT_NAME c/CONTENT pr/PRIORITY
    EDIT NOTE: notes edit INDEX [name/STUDENT_NAME] [c/CONTENT] [pr/PRIORITY]
...
*Format:*
    ...
    notes add name/STUDENT_NAME c/CONTENT pr/PRIORITY
...
*Format:*
    ...
    notes edit INDEX [name/UPDATED_STUDENT_NAME] [c/UPDATED_CONTENT] [pr/UPDATED_PRIORITY]
...
|===
|*Command*|*Format*|*Expected outcome*
|`notes add`| `notes add name/STUDENT_NAME c/CONTENT pr/PRIORITY`| Adds a note into TeaPet
|`notes edit`|`notes edit INDEX [name/STUDENT_NAME] [c/CONTENT] [pr/PRIORITY]`| Edits a note in TeaPet.
