...
=== Sticky Notes
TeaPet's Sticky Notes feature performs like the ones we all use in our everyday lives, aiming to help form teachers keep
track of important information of their students spontaneously. Every note is tagged to one or more students, such you will be able to
