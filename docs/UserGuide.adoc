...
[NOTE]
*None* of the fields can be empty. Priority must either be *LOW*, *MEDIUM* or *HIGH*. Case-insensitive.
...
[NOTE]
*At least 1* of the three prefix fields must be indicated.. Priority must either be *LOW*, *MEDIUM* or *HIGH*. Case-insensitive.
