...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String HELP_MESSAGE =
            ...
            + "\u2022 Adding events to your Personal Schedule: schedule eventName/[EVENTNAME] startDateTime/[STARTDATETIME] endDateTime/[ENDDATETIME]"
            + " recur/[DAILY/WEEKLY/NONE] color/[0-23]" + "\n" + "\n"
            + "Example: schedule eventName/Consultation startDateTime/2020-03-30T08:00 endDateTime/2020-03-30T10:00 recur/none color/3" + "\n" + "\n"
